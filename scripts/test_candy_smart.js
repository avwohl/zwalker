#!/usr/bin/env node
/**
 * Smart test for candy with z2js
 *
 * Handles random events (combat, thief, grue, etc.)
 * Commands: 100
 */

const { createZMachine } = require('./candy_z2js.js');
...
const commands = [
    "examine mephiskaphales",
    "examine fairy wallpaper",
    "take candy",
    "take shag carpet",
    "go south",
    "go east",
...
async function test() {
    ...
    console.log(' CANDY: SMART Z2JS TEST');
    console.log('='.repeat(60));
