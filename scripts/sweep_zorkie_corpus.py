...
CORPUS = {
    ...
    "zork2":           ("zork2", "zork2.zil", 3, "zork2_verified_400.txt", "zork2_verified*"),
    ...
    "ballyhoo":        ("ballyhoo", "ballyhoo.zil", 3, "ballyhoo_verified_200.txt", "ballyhoo_verified*"),
    ...
    "plunderedhearts": ("plunderedhearts", "plunderedhearts.zil", 3, "plundered_verified_25.txt", "plundered_verified*"),
    "stationfall":     ("stationfall", "stationfall.zil", 3, "stationfall_verified_80.txt", "stationfall_verified*"),
    "hitchhikersguide": ("hitchhikersguide", "hitchhikersguide.zil", 3, "hhgg_verified_400.txt", "hhgg_verified*"),
    "trinity":         ("trinity", "trinity.zil", 4, "trinity_verified_100.txt", "trinity_verified*"),
    "amfv":            ("amfv", "amfv.zil", 4, "amfv_verified_win.txt", "amfv_verified*"),
}
